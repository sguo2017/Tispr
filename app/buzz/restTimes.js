        ...
        return(
            ...
            justifyContent:'center',alignItems:'center'}}>
                    ...
                    <Text style={{color:'black',fontSize:20,margin:20}}>联系成功！</Text>
                    {
                        ...
                        <Text style={{color:'black',fontSize:20,margin:20}}>今天您还可以联系{this.props.avaliableTimes}位奇客</Text>
                        :<Text style={{color:'black',fontSize:20,margin:20}}>今天您还可以联系{this.props.avaliableTimes}个需求</Text>
                    }
