		...
		return (
			<View style={{backgroundColor: '#fff', flex: 1 }}>
				...
				<View style={{alignItems: 'center', paddingHorizontal: 16}}>
					<Image source={require('../../resource/launch-logo-s.png')} style={{marginTop: 45}}/>
					<Text style={{color: '#999999', fontSize: 12, marginTop: 40, marginBottom: 35}}>当前版本  1.01</Text>
					<Text style={{color: "black",fontSize:14, marginBottom:16, lineHeight: 26}}>
						奇客——是一个沟通、协作、基于项目制工作的自由人才服务平台。拥有奇特才华与专业技能的你就是“奇客”。通过平台，奇客们可以轻松获得客户需求信息，即时与客户沟通，高效承接工作任务，开始自由的追求事业梦想！
					</Text>
					<Text style={{color: '#4A90E2', lineHeight: 26}}>我们致力于创造一个可持续，可信赖，安全可靠的人才服务生态系统。</Text>
				</View>
