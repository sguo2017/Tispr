            ...
            justifyContent:'center',alignItems:'center'}}>
                <View style={{backgroundColor:'#fff',justifyContent:'center',width:300,height:215,alignItems:'center',borderRadius:8}}>
                    <View style={{justifyContent:'center', alignItems:'center'}}>
                        <Text style={{color:'#1B2833',fontSize:16, fontWeight:'bold'}}>不要错过最好的工作机会哦！</Text>
                        <Text style={{color:'#1B2833', fontSize:14,margin:10}}>允许推送附近发布的最新需求</Text>
                        <View style={{flexDirection:'row', justifyContent:'space-between',marginTop:20}}>
                            <TouchableOpacity 
                            style={{borderRadius:5,width:100,height:44,justifyContent:'center',alignItems:'center',marginRight:40}}
                            onPress={() => this.props.navigator.pop()}
                            >
                                <Text style={{color:'#9E9E9E'}}>残忍拒绝</Text>
                                </TouchableOpacity> 
                            <TouchableOpacity 
