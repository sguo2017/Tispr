        ...
        return(
            <View style={{width:global.gScreen.width,height:global.gScreen.height,backgroundColor:global.gColors.themeColor,
             justifyContent:'center',alignItems:'center'}}>
                <View style={{backgroundColor:'#fff',width:300,height:366,alignItems:'center', borderRadius: 4}}>
                    <Image source={require('../../resource/pupop-uploadwork.png')} style={{height: 128, width: 128, borderRadius: 64, marginTop: 38}}/>
                    <View elevation={5} style={{justifyContent:'center', alignItems:'center'}}>
                        ...
                        <TouchableOpacity
                            activeOpacity={0.75}
                            style={{flexDirection: 'row',alignItems: 'center',justifyContent: 'center',borderTopColor: '#ccc', marginTop: 32,
