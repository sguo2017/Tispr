    ...
    render(){
        return(
            <View style={{justifyContent:'flex-start',alignItems:'center',backgroundColor:'#ffffff'}}>
                ...
                <TouchableHighlight onPress={this.toSignup.bind(this)} style={{height:44,borderRadius: 5,padding:10,marginBottom:15,borderColor: global.gColors.themeColor,borderWidth:2}}>
                    <Text style={{color:global.gColors.themeColor,fontSize:16}}>
                        创建用户
                    </Text>
                </TouchableHighlight>
                 <TouchableHighlight onPress={this.toSignin.bind(this)}>
                    <Text style={{color:global.gColors.themeColor, fontSize:16, marginBottom:5, borderBottomWidth:1, borderBottomColor:global.gColors.themeColor}}>使用现有账户登录</Text>
                </TouchableHighlight>
                <Text>创建帐户您同意使用 </Text>
                <Text>
