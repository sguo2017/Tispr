...
export const FEED_EVALUATING_LIST_FETCH_LIST = 'FEED_EVALUATING_LIST_FETCH_LIST';
export const FEED_EVALUATING_LIST_RECEIVE_LIST = 'FEED_EVALUATING_LIST_RECEIVE_LIST';
export const FEED_KNOWLEDGE_LIST_FETCH_LIST = 'FEED_KNOWLEDGE_LIST_FETCH_LIST';
export const FEED_KNOWLEDGE_LIST_RECEIVE_LIST = 'FEED_KNOWLEDGE_LIST_RECEIVE_LIST';
export const FEED_DELICACY_LIST_FETCH_LIST = 'FEED_DELICACY_LIST_FETCH_LIST';
export const FEED_DELICACY_LIST_RECEIVE_LIST = 'FEED_DELICACY_LIST_RECEIVE_LIST';