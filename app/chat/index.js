...
class KnowledgeItem extends PureComponent {
    ...
    render() {
        const {feed: {serv_offer_user_name,serv_offer_titile,lately_chat_content}} = this.props
        const cellData = {serv_offer_user_name,serv_offer_titile,lately_chat_content}
