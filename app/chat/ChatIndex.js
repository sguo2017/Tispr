...
class KnowledgeItem extends PureComponent {
    ...
    render() {
        ...
        const { feed: { serv_offer_user_name, serv_offer_titile, lately_chat_content, deal_id, updated_at, status} } = this.props;
        let avatar;
        let user_name;
        ...
        const cellData = { user_name, serv_offer_titile, lately_chat_content, deal_id, avatar, updated_at, status }
